  ...
  return (
    <main>
      <div className="Content">
        ...
        <ul className="contentCards">
          ...
          <li>
            <div className="contentCard">
              ...
              />
              <div className="contentBody">
                <h5 className="contentTit">Wireless Earphone</h5>
                <div>
                  <Link to="/Earphone">
                    <button className="contentButton">Visit Store</button>
                  </Link>
        ...
        <ul className="contentMobCards">
          <li>
            <div className="contentMobCard">
              <img
                ...
                alt="..."
              />
              <div className="contentMobBody">
                <h5 className="contentMobTit">Realme</h5>
                <Link to="/Realme">
                  <button className="contentMobButton">Visit Store</button>
                </Link>
              </div>
            </div>
          </li>
          <li>
            <div className="contentMobCard">
              ...
              />
              <div className="contentMobBody">
                <h5 className="contentMobTit">Poco</h5>
                <Link to="/Poco">
                  <button className="contentMobButton">Visit Store</button>
                </Link>
              </div>
          ...
          <li>
            <div className="contentMobCard">
              ...
              />
              <div className="contentMobBody">
                <h5 className="contentMobTit">Redmi</h5>
                <Link to="/Redmi">
                  <button className="contentMobButton">Visit Store</button>
                </Link>
              </div>
          ...
          <li>
            <div className="contentMobCard">
              ...
              />
              <div className="contentMobBody">
                <h5 className="contentMobTit">Apple iPhone</h5>
                <Link to="/ApplePhone">
                  <button className="contentMobButton">Visit Store</button>
                </Link>
              </div>
          ...
          <li>
            <div className="contentMobCard">
              ...
              />
              <div className="contentMobBody">
                <h5 className="contentMobTit">Oppo</h5>
                <Link to="/Oppo">
                  <button className="contentMobButton">Visit Store</button>
                </Link>
              </div>
